...
const page = () => {
  ...
  const removeFromTopAlbums = async (albumId: string) => {
    ...
    setTopAlbums((prevTopAlbums: any) => {
      if (!prevTopAlbums || !prevTopAlbums.songs) return prevTopAlbums; // Return previous state if null or songs undefined

      return {
        ...prevTopAlbums,
        songs: prevTopAlbums.albums.filter(
      ...
      <div className="w-1/2 h-[95vh] my-4 relative flex flex-col">
        ...
        <div className="w-full min-h-[22.5vh] h-[22.5vh] bg-boxDarkGrey rounded-lg flex p-4 relative">
          ...
          <div className="flex flex-col ml-4 justify-center">
            <div className="font-bold text-6xl">My Album Songs</div>
          </div>
